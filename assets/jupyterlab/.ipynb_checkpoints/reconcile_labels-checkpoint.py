...
if __name__ == '__main__':
    ...
    lst_imgs = get_lst_images(librarydir + 'train-resized-256/')
    ...
    print("Writing CSV")
    trainLabels.to_csv(os.environ['DSX_PROJECT_DIR'] + '/datasets/trainLabels_master_256_v2.csv', index=False, header=True)

...
if __name__ == '__main__':
    #crop_and_resize_images(path=librarydir + 'train1/', new_path=librarydir + 'train-resized-256/', cropx=1800, cropy=1800, img_size=256)
    crop_and_resize_images(path=librarydir + 'test1/', new_path=librarydir + 'test-resized-256/', cropx=1800, cropy=1800, img_size=256)
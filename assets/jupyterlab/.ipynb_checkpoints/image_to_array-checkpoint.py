...
if __name__ == '__main__':
    ...
    labels = pd.read_csv(os.environ['DSX_PROJECT_DIR'] + '/datasets/trainLabels_master_256_v2.csv')

    print("Writing Train Array")
    X_train = convert_images_to_arrays_train(librarydir + 'train-resized-256/', labels)

    print(X_train.shape)

    print("Saving Train Array to Project Library")
    save_to_array(librarydir + 'X_train_256_v2.npy', X_train)

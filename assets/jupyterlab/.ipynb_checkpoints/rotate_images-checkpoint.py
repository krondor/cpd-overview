...
if __name__ == '__main__':
    ...
    trainLabels = pd.read_csv(os.environ['DSX_PROJECT_DIR'] + '/datasets/trainLabels_master.csv')
    ...
    mirror_images(librarydir + 'train-resized-256/', 1, lst_imgs_no_DR)


# Rotate all images that have any level of DR
    print("Rotating 90 Degrees")
    rotate_images(librarydir + 'train-resized-256/', 90, lst_imgs_DR)

    print("Rotating 120 Degrees")
    rotate_images(librarydir + 'train-resized-256/', 120, lst_imgs_DR)

    print("Rotating 180 Degrees")
    rotate_images(librarydir + 'train-resized-256/', 180, lst_imgs_DR)

    print("Rotating 270 Degrees")
    rotate_images(librarydir + 'train-resized-256/', 270, lst_imgs_DR)

    print("Mirroring DR Images")
    mirror_images(librarydir + 'train-resized-256/', 0, lst_imgs_DR)
